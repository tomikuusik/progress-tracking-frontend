  ...
  >
    ...
    >
      ...
      <div class="container flex justify-center content-center gap-8 mt-4">
        ...
        <button
          class="rounded-lg border-solid border-white border-2 drop-shadow h-8 w-32 bg-gradient-to-r from-red-400 to-red-500 hover:drop-shadow-md active:scale-95 uppercase font-black text-lg text-zinc-100 hover:shadow-lg hover:shadow-red-400"
          @click="deleteCourse"
        >
          delete
        </button>
